...
import { AuthInterceptor } from "./private-app/utils/auth.interceptor";
import { PublicAppComponent } from "./layouts/public-app/public-app.component";
import { BsDropdownModule } from "ngx-bootstrap/dropdown";
import { BrowserAnimationsModule } from "@angular/platform-browser/animations";
import { TabsModule } from "ngx-bootstrap/tabs";
import { IConfig, provideEnvironmentNgxMask } from "ngx-mask";
import { GrdFilterPipePipe } from "./pipes/grd-filter-pipe.pipe";
...
function initializeAppFactory(
  config: StartupConfigurationService
): () => Observable<any> {
  return () => config.load();
}
