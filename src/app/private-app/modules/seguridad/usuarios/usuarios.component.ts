...
import { IHeader } from 'src/app/private-app/interfaces/header';
...
import { IUsuario } from 'src/app/private-app/interfaces/seguridad/usuario';
import { SeguridadService } from '../seguridad.service';
import { AdministracionService } from '../../administracion/administracion.service';
import { IRespuestaHttp } from 'src/app/private-app/interfaces/compartido/resultado-http';
import { EstadosHttp } from 'src/app/private-app/constants/estado-http';
import { ICatalogoGeneral } from 'src/app/private-app/interfaces/administracion/catalogo';
...
export class UsuariosComponent implements OnInit, OnDestroy {
  ...
  obtenerEncabezadoTabla() : IHeader[] {
    let encabezados : IHeader [] = [
      { text: 'Nombres', width: '20%', align: 'center'},
      { text: 'Correo Institucional', width: '10%', align: 'center'},
      { text: 'Correo personal', width: '10%', align: 'center'},
      { text: 'Puesto', width: '10%', align: 'center'},
      { text: 'Telefono', width: '10%', align: 'center'},
      { text: 'Fecha Registro', width: '10%'},
      { text: 'Estado', width: '7%', align: 'center'},
      { text: 'Roles', width: '7%', align: 'center' },
